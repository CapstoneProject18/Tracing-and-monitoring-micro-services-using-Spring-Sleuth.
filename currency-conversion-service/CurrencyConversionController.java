...
convertCurrency(@PathVariable String from,@PathVariable String to,@PathVariable BigDecimal quantity){
...
new RestTemplate().getForEntity(
 "http://localhost:8000/currencyexchange/from/{from}/to/{to}",CurrencyConversionBean.class,uriVariables );
